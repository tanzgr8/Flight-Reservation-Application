...
function User() {
    ...
    const [book, setbook]=useState(false);
     ...
     function Reciept(){
         if(book){
         return(<> <div className="container receipt">
                 ...
                 <button className="btn btn-primary" onClick={()=>print()}>Print Reciept</button>
                 </div>
                </>
        ...
        <div className="container"> 
            ...
            <div class="px-5 row form-group">
              ...
              <div class="px-5 row form-group">
                ...
                <div className="col-sm-10">
                <select class="form-control" onChange={(e)=>setTime(e.target.value)}>
              ...
              <button type="submit" className="btn btn-primary" onClick={(e)=>handleSubmit(e)}>Book Tickets</button>
            </form>
            {
            Reciept()
            }
